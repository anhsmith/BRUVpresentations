...
![](img/length2.png){.fragment .absolute top=90 right=25 width="1024" height="336"}
...
- Annotation of 2024 Fiordland BRUV videos (ongoing, funded by MPI)
    ...
    - Focal species: blue cod, tarakihi, hāpuku, school shark
    - Two different indices of abundance: "MaxN" and "MeanCount"
    - Length frequencies (for both MaxN and MeanCount)

- 96 deployments in the Hauraki Gulf (funded by DOC)

::: {.columns}

::: {.column width="40%"} 

- Seeking joint funding with [afid.io](https://www.afid.io/) to develop AI-automated software for NZ BRUV videos, which would cut costs significantly!
...
![](vid/AFID.mp4){title="afid.io" auto-play-media="true" video-loop="true"}
