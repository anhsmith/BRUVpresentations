...
title-slide-attributes:
  ...
  In the past I’ve worked as a statistician at the Department of Conservation in Christchurch (although I now live in Orewa north of Auckland, I am a mainlander) and in the fisheries modelling group in NIWA in Wellington.<br><br>
  ...
  I first came to Fiordland in 2005, briefly ducking into Preservation Inlet during a survey of Foveaux Strait on the Renown led by Helen Kettles, and then in 2006 I participated in a broader marine survey of Fiordland on the Southern Winds. Erin Green and I were briefly joined by a great white shark while diving on Clio Rocks in Bligh Sound, a story some of you might have heard.
"
format: 
  revealjs:
...
Broad agreement -- why put this point here? 

- In my role as a scientist, I try to put aside my own values because they're not really relevant to my scientific work. 
- I'm not here to convince anyone about what they should and shouldn't value
- It’s the role of groups like the Guardians to represent the values of the citizens and stakeholders.
- As a scientist, my role is to provide scientific information and advice based on empirical observations. And that role is better served by having principles rather than values. Principles like openness, honesty, objectivity, transparency, and equanimity. 
- You could say that my only value is the pursuit of the truth, whatever that may be.
- While I have no problem with advocacy groups, I generally avoid advocacy because it interferes with my role as a scientist. It is difficult to remain objective if one has entrenched opinions about what you want the truth to be.
...
To ensure management is justified and effective, we need good information on the current state of populations, the density of individuals, even if just as a relative measure, and also information on the size and sex structure of the population

Furthermore, we need to know something about population trends through time. This is true especially when there are changes to regulations. 

For trends, we need regular monitoring. The more often we survey, the more information we have on trends. There's simply no substitute for regular surveying if you want to know about trends.
...
There are myriad methods out there for quantifying fish populations, with all sorts of advantages and disadvantages that make them appropriate or inappropriate for any particular scenario. 

For example, 

- for broad-scale surveys across a continental shelf, research trawls might be a good idea. This sort of data can enable a full stock assessment, which can estimate the total biomass of a stock through time. This requires a truckload of data, including commercial catch data and usually fishery-independent data going back years. It is generally a very broad-scale project. 
- in relatively shallow coastal environments, counts by scuba divers works
- Tag-recapture methods can be used for some populations if you assume they mix well
...
- In the 2014 survey, 1799 blue cod were captured (1237 kg; 96% killed) 
- Non-neglible losses for a sensitive, low-productivity ecosystem
...
This situation prompted the Fiordland Marine Guardians, in a document released last year, to express an interest in investigating alternative, non-destructive methods of surveying blue cod, specifically mentioning Baited Underwater Video. 
...
A stereo baited remote underwater video
...
We used this method was used in a global study of sharks called Global FinPrint, which surveyed sharks on coral reefs all over the world.
...
Each video must be annotated, which is the process of reviewing the footage and recording data on abundance, length, habitat, etc. We don't call this 'analysis' so as not to confuse it with statistical analysis of the data.
...
In 2021 and 2024, the Department of Conservation funded BRUV surveys of Fiordland.
...
Here's a map of the sites we surveyed in 2021 -- 90 deployments across multiple fiords.
...
Then in 2024 we did a more focused survey in Tamatea/Dusky Sound, for a total of 136 deployments.
...
This is a map of Dusky Sound. There are a couple of marine reserves in the vicinity. 

The video we just saw is this one in the Tuamoana Marine Reserve (fourth from the top of line).

The size of these points represents the counts of blue cod.

The numbers represent what's known as the "MaxN" count, which is the highest number seen on a single frame of the video.

We don't just count each fish we see, because a single fish could circle the gear 100 times and get counted 100 times.

By this method we can get some very large counts, up to 38 individuals. For snapper in the Hauraki Gulf, we've got as many as 56 in one frame. 

The average MaxN count across the whole survey was 5.5 individuals.
...
For the remaining species, such as tarakihi, I'm just going to show maps of where they were seen.

Solid points are sites where we saw tarakihi; open circles are where we didn't. They turned up in a more than half of the sites, throughout the fiord.
...
This is the same deployment as the last video I showed you, but much later on. We can see more species have arrived, notably crayfish and school shark. There are five crays and three schoolies here.
...
I was very surprised at how many school shark we saw throughout the survey -- they appeared in more than half the deployments, and throughout Dusky Sound. Up to around five individuals. I have a PhD student, Alex Burton, working on school sharks. 
...
Crayfish were also quite widespread. 
...
Of course we saw many, many other species, 37 species of fish alone, in fact
...
- Better able to understand ecosystem dynamics, which gives us a stronger basis for effective management.
...
They'll record anything that goes near a BRUV, all species of all sizes, as well as habitat information, in a permanent video archive. 
...
The gear is quite expensive to buy. All that specialist calibration hardware and software, there are the frames, torches, and software for annotating the videos -- it's all quite expensive. But the good news is that I have all of it already.
...
It seems to me that continuing with these surveys, even if it's just Dusky, is a good idea, given the sensitivity of the inner Fiordland ecosystems, concerns about population trends, and recent changes to regulations. 

I don't think it would be wise to wait another decade, or even five years, to do another survey.

Establishing a trend through time requires regular monitoring. There's really no way around this. 
...
The trouble is, like I said, we have yet to secure funding to continue this project, or even report on what we've done. 

- While MPI have been supportive, I get the feeling that MPI is more focused on managing stocks that are commercially harvested; blue cod are no longer commercially harvested in the inner fiords
- DOC are very supportive but they have a tonne of projects competing for limited funding and resources

I see a lot of potential here, given the wealth of information that this method can provide about one of the world's most interesting and quirky marine ecoystems. 

It would a shame to drop this project after such a promising start, and given the importance of monitoring to the management of these ecosystems for the future. 
