...
- In my role as a scientist, I try to put aside my own values. 
- I'm not here to convince anyone about what they should and shouldn't value. Values are subjective, and they vary from person to person.  
- It’s the role of groups like the Guardians to represent the values of the citizens and stakeholders.
- As a scientist, my values are not relevant. My role is to provide scientific information and advice based on empirical observations. And that role is better served by having principles rather than values. Principles like openness, honesty, objectivity, transparency, and equanimity. 
- I'm interested in only the truth, whatever that may be.
...
To ensure management is justified and effective, we need good information on the current state of populations, the density of individuals, even if just measured relatively through time, and perhaps information on the size and sex structure of the population.
...
- for broad-scale surveys across a continental shelf, research trawls might be a good idea. This sort of data can feed into broad scale fish stock assessment models. These models typically require a truckload of catch data going back many years, and they're done at a very broad scale, such as the whole of Southland. 
...
In the broader stock that includes Southland and Fiordland, there have been some worrying trends over the past 20 years. 
...
This situation prompted the Fiordland Marine Guardians, in a document released last year, to express an interest in investigating alternative, non-destructive methods of surveying key species in Fiordland. They specifically mention a method called Baited Underwater Video. 
...
Then, in 2024, Rich Kinsey at DOC commissioned up to do a more intensive survey of Tamatea/Dusky Sound, for a total of 136 deployments.
...
This one is interesting for a few reasons. You'll see that there is nothing much to see when it hits the floor, but after a few moments...
...
By this method, we can get some very large counts, up to 38 individual blue cod here. For snapper in the Hauraki Gulf, we've got as many as 56 in one frame. 
...
I'd like to know if you think that stereo BRUVs are the right tool, and do they meet the objectives around what we want to know? 

The trouble is, like I said, we have yet to secure funding to continue this monitoring, or even report on what we've done so far. 
...
I see a lot of potential here, given the wealth of information that this method can provide about one of the world's most interesting and marine ecosystems. 

I think it would a shame to drop this project after such a promising start, and given the importance of monitoring to the management of these ecosystems for the future. 
